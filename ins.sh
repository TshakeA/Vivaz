...
¦ NOW you can not install the SOURCE mero. \n
...
GET_INSTALL=$(redis-cli get mero_INSTALL)
fi
if [ "${GET_INSTALL}" == "Yes" ]; then
echo -e "
${SMAY}>> ${LSAMAY}Source mero${SMAY} is Already Installed ^_^ .\n${CNIL}"
...
3- And End Press Enter To Run Source mero .\n\n
