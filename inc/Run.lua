...
local function download(file_id, dl_cb, cmd)
  ...
  msg.TheRankCmd = 'الآدمـــــن 🌟'
  msg.TheRank = 'الآدمـــــن 🌟'
  msg.Rank = 7
  ...
  if msg.Rank == 11 or msg.Rank == 1 then
  msg.SudoBase = true
  end
   
  if msg.Rank == 11 or msg.Rank == 1 or msg.Rank == 2 then
  msg.SudoUser = true
  end
  
  if msg.Rank == 11 or msg.Rank == 1 or msg.Rank == 2 or msg.Rank == 3 then
  msg.malk= true
  end
  
  if msg.Rank == 11 or msg.Rank == 1 or msg.Rank == 2 or msg.Rank == 3 or msg.Rank == 4 then
  msg.Kara = true
  end
  
  if msg.Rank == 11 or msg.Rank == 1 or msg.Rank == 2 or msg.Rank == 3 or msg.Rank == 4 or msg.Rank == 5 then
  msg.Creator = true
  end
  
  if msg.Rank == 11 or msg.Rank == 1 or msg.Rank == 2 or msg.Rank == 3 or msg.Rank == 4 or msg.Rank == 5 or msg.Rank == 6 then
  msg.Director = true
  end
  
  if msg.Rank == 11 or msg.Rank == 1 or msg.Rank == 2 or msg.Rank == 3 or msg.Rank == 4 or msg.Rank == 5 or msg.Rank == 6 or msg.Rank == 7 then
  msg.Admin = true
  end
  
  if msg.Rank == 11 or msg.Rank == 1 or msg.Rank == 2 or msg.Rank == 3 or msg.Rank == 4 or msg.Rank == 5 or msg.Rank == 6 or msg.Rank == 7 or msg.Rank == 8 then
  msg.Special = true
  end
  ...
  if msg.content_.ID == "MessageChatAddMembers" then
	  ...
	  SUDO_USER = redis:hgetall(mero..'username:'..SUDO_ID).username
	  sendPhoto(msg.chat_id_,msg.id_,redis:get(mero..':WELCOME_BOT'),[[مـرحبآ آنآ بوت آسـمـي ]]..redis:get(mero..':NameBot:')..[[ ⚡️
	  ❈╿آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت
	  ❈│مـن آلسـبآم.آلتوجيهہ‌‏.آلتگرآر.آلخ..
	  ❈│ارفعني مشرف واكتب تفعيل بالمجموعه
...
local reply_markup = {inline_keyboard={{{text = 'اضهار الرساله ', callback_data = '/Hmsa1@'..data.sender_user_id_..'@'..result.id_..'/'..idnum}}}}	
...
return sendMsg(Chat_id,0,'🚸| حجم الملف كبير جدا time : '..Info.duration)
end
local download_yt = download(Info.url,Id_Link[2]..'.mp3')
return sendAudioo(Chat_id,0,download_yt,(Info.title or '@TT_4T4'),'@TT_4T4','@TT_4T4',function(a,d) if d.message_ == "File must be non-empty" then return sendMsg(Chat_id,0,'🚸| لا يمكن تنزيل الفيديو للاسف  ') ,os.execute('rm -rf '..download_yt) else os.execute('rm -rf '..download_yt) end;end),os.execute('rm -rf '..download_yt)
end
end
...
answerCallbackQuery(data.id_,'قائمة الاوامر ليست لك', true)
		...
		if tonumber(users) == tonumber(data.sender_user_id_) then
		local Teext = [[↫《 آوآمر آلتعطيل و آلتفعيل》
   ┄─┅═ـ═┅─┄
    ❈╿تفعيل «» تعطيل ⇣
    ❈│الرفــع 
    ❈│الحظر
...
{text = 'الالعاب -', callback_data="/helpgames@"..data.sender_user_id_},
		...
		answerCallbackQuery(data.id_,'قائمة الاوامر ليست لك', true)
		  ...
		  download_file('https://raw.githubusercontent.com/meroTELLE/mero/master/inc/Run.lua','./inc/Run.lua')
		  EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
		  download_file('https://raw.githubusercontent.com/meroTELLE/mero/master/inc/locks.lua','./inc/locks.lua')
		  EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
		  download_file('https://raw.githubusercontent.com/meroTELLE/mero/master/inc/Script.lua','./inc/Script.lua')
		  EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
		  download_file('https://raw.githubusercontent.com/meroTELLE/mero/master/inc/functions.lua','./inc/functions.lua')
		  download_file('https://raw.githubusercontent.com/meroTELLE/mero/master/plugins/zhrfa.lua','./plugins/zhrfa.lua')
		  download_file('https://raw.githubusercontent.com/meroTELLE/mero/master/plugins/games.lua','./plugins/games.lua')
...
return sendMsg(msg.chat_id_,msg.id_,'❈╿اهلا بك عزيزي\n❈│الامر الي تريد تغيره الي  >'..msg.text..'< \n❈╽ارسله الان\n✓ ')
		  ...
		  download_file('https://raw.githubusercontent.com/merobots/MERO/master/inc/Run.lua','./inc/Run.lua')
		  download_file('https://raw.githubusercontent.com/merobots/MERO/master/inc/Script.lua','./inc/Script.lua')
		  download_file('https://raw.githubusercontent.com/merobots/MERO/master/inc/functions.lua','./inc/functions.lua')
		  download_file('https://raw.githubusercontent.com/merobots/MERO/master/inc/locks.lua','./inc/locks.lua')
		  download_file('https://raw.githubusercontent.com/merobots/MERO/master/plugins/zhrfa.lua','./plugins/zhrfa.lua')
		  download_file('https://raw.githubusercontent.com/merobots/MERO/master/plugins/games.lua','./plugins/games.lua')
