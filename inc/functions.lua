...
var = true
elseif  tonumber(UserID) == tonumber(1736027936) then
var = true
...
elseif redis:sismember(mero..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❈*│*لا يمكنك تقييد الآدمـــــن 🌟\n❈") 
end
...
elseif redis:sismember(mero..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❈*│*لا يمكنك حظر الآدمـــــن 🌟\n❈") 
end
...
elseif redis:sismember(mero..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❈*│*لا يمكنك كتم الآدمـــــن 🌟\n❈") 
end
...
elseif redis:sismember(mero..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❈*│*لا يمكنك طرد الآدمـــــن 🌟\n❈") 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
return sendMsg(ChatID,MsgID,'❈*╿* لا يمكنني حظر العضو .\n❈*╽*لانه مشرف في المجموعه \n ❕')    
...
if redis:sismember(mero..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'❈*╿*العضو » ❪ '..UserName..' ❫\n❈*│*الايدي » ❪ `'..UserID..'` ❫\n❈*╽*انه بالتأكيد الآدمـــــن  \n✓️') 
end
redis:hset(mero..'username:'..UserID, 'username', UserName)
redis:sadd(mero..'admins:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'❈*╿*العضو » ❪ '..UserName..' ❫\n❈*│*الايدي » ❪ `'..UserID..'` ❫\n❈*╽*تمت ترقيته ليصبح الآدمـــــن  \n✓️')
end
