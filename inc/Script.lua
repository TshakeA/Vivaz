...
return '❈*╿*أهلا عزيزي '..msg.TheRankCmd..'\n❈*╽*الميديا بالتأكيد تــ✓ــم قفلها \n✓'
else
...
return '❈*╿*أهلا عزيزي '..msg.TheRankCmd..'\n❈*╽*الميديا بالتأكيد تــ✓ــم فتحها \n✓'
else 
...
if MsgText[1] == "تفعيل كول" and not MsgText[2] then
if not msg.Admin then return "❈*│*هذا الامر يخص {الادمن,المدير,المنشئ,المالك,المطور} فقط  \n❈" end
redis:set(mero..'kol:bot'..msg.chat_id_,true)  
return sendMsg(msg.chat_id_, msg.id_,'❈| تم تفعيل امر كول')
end
if MsgText[1] == "تعطيل كول" and not MsgText[2] then
if not msg.Admin then return "❈*│*هذا الامر يخص {الادمن,المدير,المنشئ,المالك,المطور} فقط  \n❈" end
redis:del(mero..'kol:bot'..msg.chat_id_)  
return sendMsg(msg.chat_id_, msg.id_,'❈| تم تعطيل امر كول')
end
...
if UserID == 779108237 or UserID == 779108237 then return sendMsg(msg.chat_id_,msg.id_,"❈*¦* لآ يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
...
DonisDown = DonisDown.."❈¦ تم تنزيله من الآدمـــــن  ✓️\n"
end 
...
sendMsg(msg.chat_id_, msg.id_,'❈┇لا تستطيع تنضيف اكثر من *~ 1000* رساله') 
return false  
end  
...
return '❈*│*  عدد جهہآتگ آلمـضـآفهہ‏‏ ⇜ ❪ '..(redis:get(mero..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫'
end
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[⚜╿اهلا انآ بوت آسـمـي ]]..redis:get(mero..':NameBot:')..[[ ✓
...
return'❈*│* شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..redis:get(mero..':addnumberusers')..'】* عضـو  🍁\n' 
end 
end
...
rm -rf functions.lua 
rm -rf locks.lua 
wget https://raw.githubusercontent.com/merobots/MERO/master/inc/Run.lua
wget https://raw.githubusercontent.com/merobots/MERO/master/inc/Script.lua
wget https://raw.githubusercontent.com/merobots/MERO/master/inc/functions.lua
wget https://raw.githubusercontent.com/merobots/MERO/master/inc/locks.lua
]]
os.execute(github)
...
local inline = {{{text="⚜│قنآهہ‏‏ آلسـورس ضـغـط هـنـآ ",url="t.me/TT_4T4"}}}
...
if msg.type == 'channel' and msg.GroupActive then
    ...
    ┄─┅═ـ═┅─┄
    ❈╿م1 » آوآمـر آلآدآرهہ‌‏
    ❈│م2 » آعدآدآت آلمـجمـوعهہ‌‏
    ❈│م3 » آوآمـر آلحمـآيهہ‌‏
    ❈│م4 » آوآمـر آلخدمــه 
    ❈│م5 » آوآمر آلتحشيش
    ❈│م6 » آلتعطيل و آلتفعيل
    ❈│م7 »  آلوضع للمجموعه
...
if not msg.Admin then return "❈*│*هذا الامر يخص {الادمن,المدير,المنشئ,المالك,المطور} فقط  \n❈" end
local text = [[↫《 آوآمر آلتعطيل و آلتفعيل》
┄─┅═ـ═┅─┄
 ❈╿تفعيل «» تعطيل ⇣
 ❈│الرفــع 
 ❈│الحظر
...
if not msg.SudoBase then return "📪¦ هذا الامر يخص {المطور الاساسي} فقط  \n" end
local Get_Files, res = https.request("https://raw.githubusercontent.com/merobots/FileMero/master/File.json")
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/merobots/FileMero/master/FileMero/"..FileName)
if res == 200 then
...
return '❈*│*عدد سحہكآتگ ⇜ ❪ '..(redis:get(mero..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n🐾'
end
...
if msg.sender_user_id_ ~= tonumber(1736027936) then return"❈*│*هذا الامر يخص {المطور السورس} فقط  \n❈" end
...
sendMsg(msg.chat_id_, msg.id_,"⚠┇عذرآ البوت ليس ادمن") 
return false  
end
...
keyboard.inline_keyboard = {
{
{text = URL.escape(ansar1), callback_data='صحيح'},{text = URL.escape(ansar2), callback_data='غلط'},
},
{
{text = URL.escape(ansar3), callback_data='غلط'},{text = URL.escape(ansar0), callback_data='غلط'},
}, 
}
...
keyboard.inline_keyboard = {
{
{text = URL.escape(ansar1), callback_data='غلط'},{text = URL.escape(ansar2), callback_data='صحيح'},
},
{
{text = URL.escape(ansar3), callback_data='غلط'},{text = URL.escape(ansar0), callback_data='غلط'},
}, 
...
keyboard.inline_keyboard = {
{
{text = URL.escape(ansar1), callback_data='غلط'},{text = URL.escape(ansar2), callback_data='غلط'},
},
{
{text = URL.escape(ansar3), callback_data='صحيح'},{text = URL.escape(ansar0), callback_data='غلط'},
}, 
}
...
{
{text = URL.escape(ansar3), callback_data='غلط'},{text = URL.escape(ansar0), callback_data='صحيح'},
}, 
}
end
local msg_id = msg.id_/2097152/0.5
...
{
{text = URL.escape(ansar2), callback_data='غلط1'},
},
{
{text = URL.escape(ansar3), callback_data='غلط1'},
}, 
}
elseif tt == 'ansar2' then
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = URL.escape(ansar1), callback_data='غلط1'},
},
{
...
sendMsg(msg.chat_id_, msg.id_,"📫┇ المعرف غلط")
end
end, nil)
end
...
text = [[❈╿آهلا انآ بــــوت آســمـي []]..redis:get(mero..':NameBot:')..[[] 🗽
...
sendPhoto(msg.chat_id_,msg.id_,redis:get(mero..':WELCOME_BOT'),[[⚜╿اهلا انآ بوت آسـمـي ]]..redis:get(mero..':NameBot:')..[[ ✓
👨🏻‍✈️│آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت
❈╽مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...
...
return sendMsg(msg.chat_id_,msg.id_,'❈*╿* لا يمكنني مسح الرساله المخالفه .\n❈*╽* لست مشرف او ليس لدي صلاحيه  الحذف \n ❈')    
  ...
  local USERCAR = utf8.len(USERNAME)
  SendMention(msg.chat_id_,datau.id_,msg.id_,"❈┃العضو » "..USERNAME.."\n❈┃قمـت بتگرآر آگثر مـن "..NUM_MSG_mero.." رسـآلهہ‌‏ , لذآ تم تقييدگ مـن آلمـجمـوعهہ‌‏ ✓\n",10,USERCAR)  
  return false
  end)
  end 
...
local sss = {
"تِٰـِۢمِٰـِۢآمِٰ بِٰـِۢشِٰـِۢﯛ̲فت آلِٰـِۢطِٰـِۢبِٰـِۢيِٰـِۢنِٰ😊❤️-",
"تمام وانت يكيوت ؟ 💕",
"تمام ئنته شلونك 😁❤️",
...
"لا تضربني لا تضرب 💃💃 كسرت الخيزارانه💃 صارلي سنه وست اشهر💃💃 من ضربتك وجعانه😹",
local she = {"الكبد مال اني هيه","ختولي ما احبهه ☹️","خانتني ويه صديقي 😔","بس لو الكفها اله اعضها 💔","خوش بنيه بس عده مكسرات زايده وناقصه منا ومنا وهيه تدري بنفسها 😁🤪","جذابه ومنافقه سوتلي مشكله ويه الحب مالتي","ئووووووووف اموت ع ربها","ديرو بالكم منها تلعب ع الولد 😶 ضحكت ع واحد قطته ايفوون 11 برو","صديقتي وختي وروحي وحياتي","فد وحده منحرفه 😥","ساكنه بالعلاوي ونته حدد بعد لسانها لسان دلاله 🙄","ام سحوره سحرت اخويا وعلكته 6 سنوات😭","ماحبها 🙁","بله هاي جهره تسئل عليها ؟","بربك ئنته والله فارغ وبطران وماعدك شي تسوي جاي تسئل ع بنات العالم ولي يله ☹️","ياخي بنيه حبوبه بس العرك معمي عليها تشرب هواي 😹",
}
local tzl = {
...
"تعال هيوو ✊😏 شو طالعه عينك ولسانك طويل سربوت  اشو تعال بله شنو هاذ ويهك هاذ 😳",
"روح من يمي لا الطمك سطره \nاكلب جهرتك 🤬\nبعدك كتكوت روح العب بعيد ابني🧑‍🦯"
}
local bos = {
"امممووااهحح شهلعسل🥺🍯💘",
...
elseif Text== "انت منو" or Text=="منو انتا" then return sendMsg(msg.chat_id_,msg.id_,"⚜╿انآ بوت بوت أسمي ["..Bot_Name.."] ✓ ⚜\n👨🏻‍✈️│آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت\n\n❈│مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...\n\n❈╽ضيفني لكروبك ورفعني مشرف بلكروب وارسل تفعيل داخل الكروب")
elseif Text== "كلخرا" or Text== "اكل خره" then return sendMsg(msg.chat_id_,msg.id_,"خرا ليترس حلكك/ج ياخرا خختفووو ابلع😸🙊💋")
...
return sendMsg(msg.chat_id_,msg.id_,"تِٰـِۢمِٰـِۢآمِٰ بِٰـِۢشِٰـِۢﯛ̲فت آلِٰـِۢطِٰـِۢبِٰـِۢيِٰـِۢنِٰ😊❤️-")
...
elseif Text== "اني"  then return sendMsg(msg.chat_id_,msg.id_,"آنِٰـِۢتِٰ / يِٰ ﯛ̲୭ردۿۿہ 🌸⇣")
...
return sendMsg(msg.chat_id_,msg.id_,"نـ﴿💡﴾ـورك/ج ؏ـمـ😲ـآني وحہـ(❈)ـہرگ بيـ🏡ـت جيہـْ✍ـہرآنيًٍِ")
end
end
...
elseif Text and  Text:match("^كول (.*)$") and redis:get(mero..'kol:bot'..msg.chat_id_)  then
...
elseif Text== "رفع بكلبي"  and msg.reply_id and not redis:get(mero.."amrthshesh"..msg.chat_id_) then    
if is_JoinChannel(msg) == false then
return false
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, function(extra, result, success) 
...
elseif Text== "تنزيل من كلبي"  and msg.reply_id and not redis:get(mero.."amrthshesh"..msg.chat_id_) then  
if is_JoinChannel(msg) == false then
return false
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, function(extra, result, success) 
...
if #list == 0 then return sendMsg(msg.chat_id_, msg.id_, "• لا يوجد جلاب") end
t = "\n• قائمة الكلاب\n━━━━━━━━\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
...
if #list == 0 then return sendMsg(msg.chat_id_, msg.id_, "• لا يوجد اعضاء بكلبي") end
t = "\n• قائمة كلبي\n━━━━━━━━\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
